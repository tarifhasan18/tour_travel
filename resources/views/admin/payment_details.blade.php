...
<body>
    ...
    <div class="container">
        <div class="page-inner">
            <div>
                <h1>All Booking Payment Details</h1>
            </div>
            ...
            <div class="tour_packages">
                <table>
                    ...
                    <tr>
                        ...
                        <td>{{ $payment_detail->paid_amount }}</td>
                        <td>
                            <a class="btn btn-success"
                                href="{{ url('approve_payment', $payment_detail->id) }}"
                                onclick="return confirm('Are you sure you want to approve this payment?')">Approve</a>
                            <a class="btn btn-warning mt-2"
                                href="{{ url('reject_payment', $payment_detail->id) }}"
                                onclick="return confirm('Are you sure you want to reject this payment?')">Reject</a>
                        </td>
        ...
        <div class="img-body">
            <div class="img-box">
                <div class="img-head d-flex justify-content-between align-items-center">
                    <p>Payment Slip</p>
                    <p style="cursor: pointer; font-size: 24px" onclick="img_full_viewer(this)"><i class="fa-solid fa-xmark"></i></p>
                </div>
