...
<div class="main-panels" style="padding-top: 120px">
    <div class="content-wrapper">
        <div class="page-header justify-content-between">
            <h3 class="page-title ml-4">Sales Report</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="input-group mb-4">
                    <div class="input-group col-xs-12">
                        <select id="deliveryManID">
                            <option value='' selected disabled>Please Select</option>
                            @foreach($delivery_man as $dman)
                                <option value='{{ $dman->login_id }}'>{{ $dman->full_name }}</option>
                            @endforeach
                        </select>
                        <span class="input-group-append">
                            <span class="file-upload-browse btn btn-primary"> Delivery Man </span>
                        </span>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
                    ...
                    success: function(data) {
                        ...
                        $.each(data.singleDateSales, function(col, dsdata) {
                            ...
                            dshtml='<tr>'
                                ...
                                dshtml+='<td>'+ dsdata.cart_id +'</td>'
                                dshtml+='<td>'+ dsdata.full_name +'</td>'
        ...
        $(document).on('change','#deliveryManID', function (event) {
